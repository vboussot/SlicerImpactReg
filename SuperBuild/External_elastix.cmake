...
list(APPEND ${proj}_DEPENDS torch)
...
if(NOT DEFINED ${proj}_DIR AND NOT ${CMAKE_PROJECT_NAME}_USE_SYSTEM_${proj})
  ...
  set(ELASTIX_GIT_REPOSITORY "https://github.com/vboussot/ImpactElastix.git")
  set(ELASTIX_GIT_TAG "feature/impact-metric")
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_CACHE_ARGS
      ...
      -DTorch_DIR:PATH=${torch_DIR}/share/cmake/Torch
